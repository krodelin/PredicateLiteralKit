...
pred_string = @"name IN { 'Ben', 'Melissa', 'Nick' } &&  date > $YESTERDAY OR date > 3 || TRUEPREDICATE || date < 4 && age >= 4 OR age <= 5 AND type == \"type\" and name LIKE \"Udo\" and not age != ((((3+4)*5-6)/7)**5) and size == array[SIZE]";
