...
var stream = require("narwhal/term").stream,
    ...
    productName = "PredicateLiteralKit",
...
task ("help", function()
{
    ...
    colorPrint("JSONPredicateKit - Framework", "bold+green");
    colorPrint("--------------------------------------------------------------------------", "bold+green");
